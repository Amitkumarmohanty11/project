...
function Login() {
    ...
    return (
      <div style={{display: 'grid', placeItems:'center' , width: "400px " ,margin:"auto", overflow:"hidden",
      border: "1px solid black", boxShadow:"2px 2px 2px 2px black", backgroundColor: "gray"}}>
        <h2>Login</h2>
